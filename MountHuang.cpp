    ...
    : QMainWindow(parent)
{
    ...
    //QIcon icon("image/anon.jpg");
    button_ciguangge->setStyleSheet("border-image: url(image/anon2.jpg);border-radius: 10px;");
    //button_ciguangge->setIcon(icon);
    ...
    button_miaobishenghua->setStyleSheet("border-image: url(image/anon2.jpg);border-radius: 10px;");
    ...
    button_yungusi->setStyleSheet("border-image: url(image/anon2.jpg);border-radius: 25px;");
    ...
    button_yingkesong->setStyleSheet("border-image: url(image/anon2.jpg);border-radius: 10px;");
    ...
    button_guangmingding->setStyleSheet("border-image: url(image/anon2.jpg);border-radius: 10px;");
    ...
    button_nandamen->setStyleSheet("border-image: url(image/anon2.jpg);border-radius: 10px;");
    ...
    button_yupingzhan->setStyleSheet("border-image: url(image/anon2.jpg);border-radius: 10px;");
    ...
    button_baieling->setStyleSheet("border-image: url(image/anon2.jpg);border-radius: 10px;");
