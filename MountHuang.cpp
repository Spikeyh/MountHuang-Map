...
Dijkstra::Dijkstra(QWidget* parent) : QMainWindow(parent)
{
    ...
    QGraphicsPixmapItem* item = scene->addPixmap(QPixmap("image/map2.jpg").scaled(this->size()));
...
{
    mgraph.arcs[0][1].adj = mgraph.arcs[1][0].adj = 187;    //南大门0-云谷寺1
    mgraph.arcs[0][2].adj = mgraph.arcs[2][0].adj = 153;   //南大门0-慈光阁2
    mgraph.arcs[1][2].adj = mgraph.arcs[2][1].adj = 321;    //云谷寺1-慈光阁2
    mgraph.arcs[2][3].adj = mgraph.arcs[3][2].adj = 126;    //慈光阁2-迎客松3
    mgraph.arcs[3][4].adj = mgraph.arcs[4][3].adj = 122;    //迎客松3-光明顶4
    mgraph.arcs[4][5].adj = mgraph.arcs[5][4].adj = 104;  //光明顶4-梦笔生花5
    mgraph.arcs[1][5].adj = mgraph.arcs[5][1].adj = 185;  //梦笔生花5-云谷寺1
    mgraph.arcs[2][6].adj = mgraph.arcs[6][2].adj = 189;  //慈光阁2-玉屏站6
    mgraph.arcs[3][6].adj = mgraph.arcs[6][3].adj = 91;  //玉屏站6-迎客松3
    mgraph.arcs[1][7].adj = mgraph.arcs[7][1].adj = 53;  //云谷寺1-白鹅岭7
    mgraph.arcs[5][7].adj = mgraph.arcs[7][5].adj = 94;  //白鹅岭7-梦笔生花5
...
void Dijkstra::FindPath()
{
    ...
    for (int i = 0; i < nextPath.size(); i++) {
        pathText += getSpotName(nextPath[i]) + "\n";
    }
...
//        scene->addPixmap(QPixmap("image/map2.jpg").scaled(this->size()));
